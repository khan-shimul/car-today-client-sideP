...
const Login = () => {
    ...
    const { loading, loginUser, signInUsingGoogle, error } = useAuth();
            ...
            <div className="row d-flex justify-content-center align-items-center my-5">
                <div className="col-md-6">
                    {!loading && <form onSubmit={handleSubmit(onSubmit)} className="d-flex flex-column login-form">
                        ...
                        <Button onClick={() => signInUsingGoogle(location, history)} className="p-2" variant="primary"><i className="fab fa-google"></i> Google</Button>
                    </form>}
